...
export class FilepathHelper {
  ...
  public static savedComparisonImgPath(project: string, setId: string, imgFilename: string): string {
    return path.join(this.savedComparisonSetDir(project, setId), imgFilename);
  }
